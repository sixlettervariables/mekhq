...
public class ContractMarketDialog extends JDialog {
	...
	private void acceptContract(ActionEvent evt) {
	    if(selectedContract != null) {
	    	...
	    	campaign.getFinances().credit(selectedContract.getTotalAdvanceMonies(), Transaction.C_CONTRACT, "Advance monies for " + selectedContract.getName(), campaign.getDate());
